...
const routes: Array<RouteRecordRaw> = [
  ...
  },
  {
    path: "/edicao",
    name: "edicao",
    component: () => import(/* webpackChunkName: "editorEmenda" */ "../views/emenda/EditorEmendaView.vue"),
    props: true,
  },
  {
    ...
    component: () =>
      import(/* webpackChunkName: "pesquisaProposicao" */ "../views/pesquisaProposicao/PesquisaProposicaoView.vue"),
    props: true,
  },
];
    ...
    return new Promise<ScrollPosition | false>((resolve) => {
      if (!savedPosition) {
        ...
        const recursiveScrollToPosition = () => {
          clearInterval(timer);
          const segundosDecorridos = (new Date().getTime() - momentoInicial.getTime()) / 1000;
          ...
          /*
                    ...
                    */
          if (segundosDecorridos < 2000 && height < savedPosition.top) {
